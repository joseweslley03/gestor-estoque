    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('F', 'Fisico'), ('D', 'Digital')], max_length=1)),
            ],
            options={
                'db_table': 'locais',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_fabricante', models.CharField(max_length=50, verbose_name='Código do fabricante')),
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produtos.produto', verbose_name='produto da movimento')),
            ],
            options={
